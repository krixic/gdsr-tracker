export const changelogContent = [
    ...
    },
    {
        ...
        title: "Other Minds",
        changes: [
            "Big update, thanks to everyone that actually use this site, it's come a long way from just a small little web project to a tool that people can actually use.",
            "Fully refactored the list select with a new dropdown tree structure, added new lists: GDSR Ship, GDSR Ship DLC, CCPL DLCs (Tiny, Consistency, Secret), NLW + LW",
            "New footer look because other one was chopped, fixed resetting attempt count by deleting the input value",
            "Added periodic sheet refresh, levels do not need to be updated by me anymore and levels are automatically fetched, currently it is still manual to refetch levels but this can change to be automatic maybe",
            "If you are also interested in contributing to the source code or just have suggestions for the site, feel free to do so, the site is open-sourced on [GitHub](https://github.com/krixic/gdsr-tracker)",
            "[ohnepixel Loses It Trying to Fix His NEW Wheel For 3 Hours Again...](https://www.youtube.com/watch?v=LIWZcsyC65k)",
        ],
    },
    {
        id: "2026-02-06",
        ...
        changes: [
            ...
            "[ohnepixel Loses It Trying to Fix His Wheel For 4 hours...](https://www.youtube.com/watch?v=sncRU788fiQ)",
        ],
    },
];
